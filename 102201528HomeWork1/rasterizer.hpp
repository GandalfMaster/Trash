...
namespace rst
{
    ...
    public:
        ...
        void set_sample_pixel(const Eigen::Vector3f& point, const Eigen::Vector3f& color, int offset);
    ...
    private:
        ...
        void super_rasterize_triangle(const Triangle& t);
    ...
    private:
        ...
        float superOffsetX[4] = { 0.25, 0.25, 0.75, 0.75 };
        float superOffsetY[4] = { 0.25, 0.75, 0.25, 0.75 };
